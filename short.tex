...
When constructing a pomset, we define $\rpox$ in the obvious way.
...
\begin{proof}[Proof Sketch]
    ...
    note that $\le_*$ (the transitive reduction $\le$) can be decomposed into
    ...
    read and write accesses before writes, as required by item 4.
...
between to actions outside of $P$ --- in this case, between the new read of
