...
the obvious definition may result in cycles, since events may coalesce.  In
...
\begin{proof}[Proof Sketch]
  ...
  satisfying requirement \ref{rf4}\footnote{Within a thread,
  fulfillment requirements \ref{rf3} and \ref{rf4} follow from prefixing
  requirement \ref{5b}, which is included in ${\rppo}$.}.
