...
adjacent to $\aEv$.  We say they are \emph{similar} if they are
$\aEv$-similar for some $\aEv$.  Formally:
$\Event'=\Event$,
...
\begin{theorem}
  ...
  some $\aCmd$-extension $\aPS'''$ of $\aPS'$ that is 
  $L$-sequential after $\aPS$ such that (a) $\aPS'''$ is similar to $\aPS''$
  and (b)
  \begin{math}
    \exists\bEv\in(\Event''\setminus\Event'):\;
    \exists\aEv\in(\Event''\setminus\Event):\;
    \;\bEv\lrace{L}\aEv).
  \end{math}
\begin{proof}[Proof Sketch]
    ...
    $\aPS''$ on the left to below to $\aPS'''$ on the right.  Program order
    ...
    \begin{gather*}
      ...
      \hbox{\begin{tikzinline}[node distance=1em and 2em]
          ...
          \bgoval[green!10]{(ry1)(wx1)(rx0)(wy1)}{P'''\setminus P'}
        \end{tikzinline}}
      \qquad
      \hbox{\begin{tikzinline}[node distance=1em and 2em]
          \event{wy0}{\DW{y}{0}}{}
    ...
    \begin{gather*}
      x\GETS 0 \SEMI y\GETS 0 \SEMI (\aReg \GETS y  \SEMI x \GETS 1
      \PAR
