...
\newcommand{\tvalpom}{3-valued pomset}
\newcommand{\tsem}[1]{\llbracket#1\rrbracket_{{\bf 3}}}
\newcommand{\tsemsc}[1]{\llbracket#1\rrbracket_{{\bf 3SC}}}
\newcommand{\tsemClosed}[1]{\closed\tsem{#1}}
\newcommand{\readc}{\overline{\mathsf{read}}}
