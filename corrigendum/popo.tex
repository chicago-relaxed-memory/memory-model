...
\begin{gather*}
  ...
  y\GETS0\SEMI
  (
  x^\mRA\GETS1\SEMI\aReg\GETS y
  \PAR
  y^\mRA\GETS1\SEMI \aReg\GETS x)
  \\
  \hbox{\begin{tikzinline}[node distance=1em]
      \event{wx0}{\DW{x}{0}}{}
...
\begin{gather*}
  \aLoc\GETS0\SEMI\bReg\GETS \FADD^{\mRLX,\mRLX}(\aLoc)
  \PAR
...
\begin{gather*}
  ...
  \PAR
  \FENCE^{\mREL}\SEMI
  r\GETS \FADD^{\mRLX,\mRLX}(x) \SEMI  %1
  x\GETS 3
  \PAR
  r\GETS x^\mRA \SEMI %3
  s\GETS y %0
