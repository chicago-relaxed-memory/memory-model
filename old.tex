...
%\begin{displaymath}
 ...
 % x^\mRA\GETS1\SEMI a\GETS y
 % \PAR
 %% x \GETS0 \SEMI %\FENCE\SEMI
 % y^\mRA\GETS1\SEMI b\GETS x
%\end{displaymath}
%\begin{tikzdisplay}[node distance=1em]
 % \event{a1}{\DW{y}{0}}{}
...
\begin{displaymatharray}{rl}
  &x\GETS0\SEMI x\GETS 1
  \PAR
  \IF{x^\mRA}\THEN r\GETS y \FI
 \\{}
  \PAR&
  y\GETS0\SEMI y\GETS 1
  \PAR
  \IF{y^\mRA}\THEN s\GETS x \FI
\end{displaymatharray}
...
\begin{tikzdisplay}[node distance=1em]
  ...
  \event{wy0}{\DW{y}{0}}{below=4ex of wx0}
  \event{wy1}{\DW{y}{1}}{right=of wy0}
  \event{ry1}{\DR{y^\mRA}{1}}{right=2.5em of wy1}
  \event{rx0}{\DR{x}{0}}{right=of ry1}
  \event{rx1}{\DR{x^\mRA}{1}}{right=2.5 em of wx1}
  \event{ry0}{\DR{y}{0}}{right=of rx1}
  \wk{wx0}{wx1}
  \wk{wy0}{wy1}
  \rf{wx1}{rx1}
...
\begin{gather*}
  \aReg\GETS a^\mRA\SEMI
  x\GETS1 \SEMI
  b\GETS^\mRA 1
  \PAR
  \aReg\GETS c^\mRA\SEMI
  x\GETS2 \SEMI
  d\GETS^\mRA 1
  \PAR
  \aReg\GETS e^\mRA\SEMI
  \bReg\GETS x \SEMI
  f\GETS^\mRA 1
  \\[-2ex]
...
% \textcoor{red}{TODO: Is there any example that makes use of this lack of
...
\begin{displaymath}
  x\GETS1 \SEMI
  a^\mRA\GETS1 \SEMI
  \IF{b^\mRA}\THEN  \aReg\GETS x\SEMI y\GETS\aReg \FI
  \PAR
...
\BNFSEP \aReg\GETS\REF{\cExp}^\mRA\SEMI \aCmd 
\BNFSEP \aReg\GETS\REF{\cExp}\SEMI \aCmd
\BNFSEP \REF{\cExp}^\mRA\GETS\aExp\SEMI \aCmd
...
\begin{align*}
  ...
  % \sem{^\mRA\aLoc\GETS\aExp\SEMI \aCmd} & = \textstyle\bigcup_\aVal\; \bigl((\aExp=\aVal) \guard (\DWRel\aLoc\aVal) \prefix \sem{\aCmd}\bigr)[\aExp/\aLoc] \\
  ...
  % \sem{^\mRA\aReg\GETS\aLoc\SEMI \aCmd} & =  \textstyle\bigcup_\aVal\; (\DRAcq\aLoc\aVal) \prefix \sem{\aCmd}[\aLoc/\aReg] \\
...
\begin{tikzdisplay}[node distance=1em]
    \event{b}{\DR\bLoc1}{}
    \internal{ry1}{\bLoc\leq1\DR{\bLoc}{1}}{right=of b}
...
\begin{tikzinline}[node distance=1em]
    ...
    \internal{ry1}{0 \leq0\DR{\bLoc}{1}}{right=of b}
