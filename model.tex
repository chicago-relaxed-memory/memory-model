...
\begin{displaymath}
  ...
  x\GETS z
\end{displaymath}
The precondition for the write $\DW{z}{1}$ is $y=1$.  This precondition is discharged internally by the write of $y=1$ without an externally visible dependency to an explicit read. 
\begin{tikzdisplay}[node distance=1em]
  \event{a1}{\DR{x}{1}}{}
