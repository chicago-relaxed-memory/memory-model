...
\begin{align*}
  \hbox{\begin{tikzinline}[node distance=.2em]
      \event{a}{r{=}0\mathbin{\mid}\DW{a[0]}{0}}{}
      \event{b}{r{=}0\mathbin{\mid}\DW{a[0]}{1}}{right=of a}
    \end{tikzinline}}%\;\;\cdots
  \qquad
  %\\[-1.5ex]\intertext{and:}\\[-5ex]
  \hbox{\begin{tikzinline}[node distance=.2em]
      \event{a}{r{=}1\mathbin{\mid}\DW{a[1]}{0}}{}
      \event{b}{r{=}1\mathbin{\mid}\DW{a[0]}{0}}{right=of a}
    \end{tikzinline}}%\;\;\cdots
\end{align*}
...
\begin{gather*}
  \hbox{\begin{tikzinline}[node distance=.5em]
      \event{a}{r{=}0\lor r{=}1\mathbin{\mid}\DW{a[0]}{0}}{}
      \event{b}{r{=}0\mathbin{\mid}\DW{a[0]}{1}}{right=of a}
      \event{c}{r{=}1\mathbin{\mid}\DW{a[1]}{0}}{right=of b}
    \end{tikzinline}}%\;\;\cdots
\end{gather*}
...
\end{displaymath}
No similar change is needed for read actions: the read rule does not
introduce preconditions, and item 5a of Definition \ref{def:prefix} ignores
