...
As in \citep{2019-sp}, weakening of preconditions\footnote{Formula $\psi$ is \emph{weaker} than a formula $\phi$ if $\phi \Rightarrow \psi$.}can also happen by merging
...
inlining. \textsection\ref{sec:examples} develops some of these examples.
