...
security flaws, such as Spectre \cite{DBLP:journals/corr/abs-1801-01203}.
Perhaps surprisingly, these pomsets provide a natural, abstract view of
\emph{multi-copy atomic (MCA)} memory architectures, using only two
well-understood relations that have been around since the 1980s.  
