...
are closed with respect to \emph{implication}, \emph{disjunction},
\emph{augmentation}, and \emph{prefixing}: %, and \emph{isomorphism}:
\begin{definition}
  Let
  ...
  %
  Let $\aPS'$ be a \emph{disjunct} of $\aPS^i$ if $\Event' =
  \Event^i$, ${\le'}={\le^i}$,
  $\labelingAct'=\labelingAct^i$, and
