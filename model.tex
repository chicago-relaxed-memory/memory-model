...
\item[{\labeltextsc[P5a]{(P5a)}{5a}}]\labeltextsc[P5]{}{5}%
  ...
  implies $\labelingForm(\aEv)$ or $\bEv\lt'\aEv$,
...
\item[{\labeltextsc[P5b]{(P5b)}{5b}}]
  if $\bEv$ and $\aEv$ are \external actions in conflict then $\bEv\lt'\aEv$, %$\bEv \gtN' \aEv$,
...
\end{gathered}
\end{gather*}
The difference between \eqref{unexpected} and \eqref{OOTA!} can be seen
in the conditional
\begin{math}
