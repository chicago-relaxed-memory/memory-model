...
%     \end{tikzinline}}
% \end{gather*}
Our model forbids the
following, which C11 allows 
\citep[\textsection8.2]{Dolan:2018:BDR:3192366.3192421}:
\begin{gather*}
  ...
  \hbox{\begin{tikzinline}[node distance=1em]
    ...
    \end{tikzinline}}
\end{gather*}
The order from $(\DW{x}{1})$ to $(\DW{x}{2})$ is required to fulfill $(\DR{x}{2})$. %by fulfillment.
