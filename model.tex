...
Hoare logic---for writes, the rule is left disjunction:
\begin{displaymath}
  \frac{
...
a read introduce at most one event per pomset.  Thus, we use $\cup$ to
combine pomsets for different read values, rather than $\parallel$.
