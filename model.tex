...
In the next section, we explain item the concurrent semantics using standard
...
end with a discussion of \ref{5a}, which connects the concurrent and
sequential semantics.

Let us revisit the unexpected execution of \ref{OOTA?}, explained in \textsection\ref{sec:domain}:
\begin{gather*}
  y\GETS 0 \SEMI x\GETS 0\SEMI (y\GETS x
  \PAR
  r\GETS y\SEMI \IF{r}\THEN 
