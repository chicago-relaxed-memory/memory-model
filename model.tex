...
Let us revisit the unexpected execution \eqref{unexpected} of \eqref{OOTA?}, as explained in
...
As mentioned in \textsection\ref{sec:domain}, an attempt to replicate this execution with \eqref{OOTA!} fails,
introducing a cycle:
\begin{gather*}
  y\GETS 0 \SEMI x\GETS 0\SEMI (  y\GETS x
  \PAR
