...
We expect each pomset to have at most one termination event.
A pomset is \emph{completed} if it contains a termination. %$\exists\aEv.\;\labelingAct(\aEv)=\DSTOP$. % and $\forall\bEv.\;\bEv\le\aEv$.
