...
The write substitution may allow preconditions to weaken---without imposing
...
compiler analysis, possibly in collusion with the scheduler: If every visible
racing value can be shown to satisfy a precondition, then the precondition
can be dropped. (The last example above shows the effect of coherence.)  For
...
The use of \textsf{cover} in the definition prevents the local
