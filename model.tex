...
\begin{tikzdisplay}[node distance=1em]
  ...
  \wk{rx2a}{wx3}
\end{tikzdisplay}
The restriction of $\geN$ to events that read or write any single location is called the \emph{extended coherence order}, $\reco$.  Since $\geN$ is a partial order, so is $\reco$.  
