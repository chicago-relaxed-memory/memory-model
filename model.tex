...
Prefixing adds a new event to a pomset.  We present a candidate definition for prefixing.  The full definition follows
in \textsection\ref{sec:refine}.   We expect the semantics to be downclosed.
The definition is simplified by performing this closure explicitly.
