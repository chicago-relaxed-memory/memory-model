...
Similar cycles arise when attempting to write $z{=}1$ in \ref{OOTA3} and \ref{OOTA4}.
...
(Definition\ref{def:mmpomset}).  However, the definition allows events with
