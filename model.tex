...
\begin{definition}
  ...
  $\{\aPS^1,\,\aPS^2\}\subseteq \aPSS$ and $\aPS^0$ is a disjunct of $\aPS^1$
  and $\aPS^2$ implies $\aPS^0\in\aPSS$.
\end{definition}

  We say that $\aPS^0$ is a \emph{disjunct} of $\aPS^1$ and $\aPS^2$ when
  $\Event^0=\Event^1 =\Event^2$, ${\le^0}={\le^1}={\le^2}$,
  $\labelingAct^0=\labelingAct^1 =\labelingAct^2$, and
  $\labelingForm^0(\aEv)$ implies $\labelingForm^1(\aEv)\lor \labelingForm^2(\aEv)$.
...
\todo{Note that downset closure is required for this definition to
  be sensible.}
...
of \citet{DBLP:journals/pacmpl/PodkopaevLV19}: \todo{Bad break}
\begin{gather*}
  \taglabel{Internal2}
  \aReg\GETS x\SEMI
  y\REL\GETS 1\SEMI
