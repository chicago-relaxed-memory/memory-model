...
Candidate \ref{cand:ord} does not validate case analysis, irrelevant read
elimination, or irrelevant write elimination.  Here, we discuss refinements
to the definition of prefixing that validate these rewrites.  We also discuss
