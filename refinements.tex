...
\begin{definition}
  \label{def:cover}
  Extend the definition of prefixing (Candidate \ref{def:prefix}) to require:
  ...
  \end{align*}
\end{definition}
There are four changes in the definition: To validate case analysis, we apply
$\Rdis{\aLoc}{\aVal}$ before prefixing a read.  To validate read elimination,
...
include $\relfilt[]{\aLoc} \sem{\aCmd}[\aExp/\aLoc]$.
