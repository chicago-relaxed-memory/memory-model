...
% analysis \eqref{CA}:
In the definition of composition, any actions with the same label and downset
...
elimination (which is unsound) and reordering with external actions (which we
do not model.)
