  ...
  \begin{itemize}    
    ...
    \item In the JMM, OOTA5 \emph{``is type correct if it declares
      ...
      \item<5-> To prove safety, Lochbihler partitions memory by type
        ...
        \end{itemize}
      \end{itemize}
    \item<7-> OOTA is a \emph{queasy feeling} \only<8->{--- Compositionality is a \emph{verifiable property}}
      \begin{itemize}
      \item<9-> Predicate logic rules out OOTA1-OOTA3
      \item<9-> Temporal logic rules out OOTA4
      \end{itemize}
    }
    \only<10->{
    \item In OOTA4, every thread satisfies:
      ...
      \item
        ...
        \end{math}
      \end{itemize}
    \item<11-> By compositionality, whole program should satisfy this
      \begin{itemize}
      \item[\xmark] Existential justification 
      \item[\cmark] Universal justification 
      \end{itemize}
    }
  \end{itemize}  
\end{frame}
...
\begin{frame}
  ...
  \item Limitations
    ...
    \item No loops or functions 
    \item No sequential composition
    \item No mixed size access
