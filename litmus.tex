...
%       \event{b2}{\DW[\mRA]{\,z}{1}}{right=of b1}
%       \sync{b1}{b2}
%       \event{c1}{\DR[\mRA]{y}{1}}{right=2em of a2}
%       \event{c2}{\DR[\mRA]{\,z}{1}}{right=2em of b2}
...
% \begin{align*}
%   \begin{gathered}
%     \IF{r=1}\THEN \PW{x}{r}\SEMI \PW{x}{1} \ELSE \PW{x}{1}\FI
%     \\
%     \hbox{\begin{tikzinline}[node distance=1.5em]
...
% 5.3.1]{SevcikThesis}:
% \begin{displaymath}
%   \sem{\PR{x}{r}\SEMI \PW{x}{r}\SEMI \PR{x}{s} \SEMI \IF{\aReg {\neq} \aReg} \THEN \PW{y}{1} \FI}
%   \not\supseteq
%   \sem{\PR{x}{r}\SEMI \PR{x}{s}  \SEMI \IF{\aReg {\neq} \aReg} \THEN \PW{y}{1} \FI}
% \end{displaymath}
% These are distinguished by the context %
% \begin{math}
%   \PW{x}{1} \SEMI a^\mRA\GETS 1
%   \PAR \PW{x}{2} \SEMI \PW[\mRA]{z}{1}
...
% \begin{displaymath}
%   \sem{\PW{\aLoc}{0} \SEMI\PW{\aLoc}{1} \SEMI\bLoc^\mRA\GETS 1} 
%   \not\supseteq
%   \sem{\PW{\aLoc}{0} \SEMI\bLoc^\mRA\GETS 1}
% \end{displaymath}
% These are distinguished by the context:
% \begin{math}
%   \hole{} \PAR
%   \IF{\bLoc^\mRA}\THEN \aReg \GETS \aLoc \FI
% \end{math}


% But even \emph{irrelevant} read introduction is invalid:
% $\sem{\SKIP}\not\supseteq\sem{\PR{x}{r}}\not\supseteq\sem{\PR{x}{r}\SEMI \PR{x}{r}}$.  These inequations hold even though there is no context in our
% language that distinguishes these programs.
