...
The paper develops an axiomatic and studies effects on compilation.  It is
designed as a restriction of the \jmm\ that compiles efficiently to \tso, but
requires fencing on other architectures.
...
In \textsection\ref{sec:opt}, we formalized a connection between Hoare logic
...
compiler optimizations are invalid in the Java Memory Model
...
semantics \cite{DBLP:conf/popl/KangHLVD17}, but not in \weakestmo{}
