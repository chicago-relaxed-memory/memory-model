...
We do not include loops or general sequencing of the form $(\aCmd\SEMI\aCmd')$.
Loops introduce complexities\allowbreak{}---such as liveness and
continuity---that are orthogonal to the main topic of the paper.  We also do
not include types, allocation, garbage collection, etc.  % This is the norm for
...
support elimination of redundant synchronization accesses or lock elision.  Nor does it
support conversions between access modalities.
\begin{scope}
