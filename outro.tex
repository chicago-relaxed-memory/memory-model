...
For stronger models
\cite{Boehm:2014:OGA:2618128.2618134,Dolan:2018:BDR:3192366.3192421}, it is
likely sufficient to require more order in the pomset.  To compile
efficiently to weaker architectures, such as \ppc\ and \armseven, it is
...
\begin{gather*}
  ...
  \wk{wx2}{rx3}
    \end{tikzinline}}
\end{gather*}
This example requires a logic with modalities to deal with intervening writes
and coherence.
