...
statement about transformations.  We present a solution to a problem that has
been open since \citet{DBLP:conf/ecoop/SevcikA08} discovered that several
sequential program transformations are invalid in the Java Memory Model
\citet{Manson:2005:JMM:1047659.1040336},

In \textsection\ref{sec:logic}, we proposed a cyclical proof rule for
parallel composition of temporal properties in style of
...
These contributions rest on semantics that supports a simple, executable
prescription of \emph{essential dependencies}.  This specification provides a
...
$\DR{y}{1}$.   This example require the ability to reason about values.
