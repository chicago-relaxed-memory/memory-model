...
The following program ``is type correct if it declares $x$, $y$ and $r$ of type \texttt{D}. However, it has a legal execution [in Java \cite{Manson:2005:JMM:1047659.1040336}] where they reference a \texttt{C} object'' \citep[Fig.~8]{DBLP:journals/toplas/Lochbihler13}:
%\vspace{-.5ex}
\begin{gather}
  \label{lochbihler}
  \begin{aligned}
...
First, we weaken the program-order within a thread to capture only essential dependencies.
