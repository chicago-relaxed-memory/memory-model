...
Let $\sem{\aCmd}'$ be the semantics of \textsection\ref{sec:model:intro},
extended with silent actions and fences.  We expect:
\begin{align*}
  \sem{\aCmd}' &= \{ \aPS\in\sem{\aCmd} \mid \disjoint{\Event}{\Sub}\}
  \\
  ...
  \sem{(\IF{\aExp} \THEN \aCmd_1 \ELSE \aCmd_2\FI)\SEMI\bCmd}
\end{align*}
