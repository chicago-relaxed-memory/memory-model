...
Let $\aPS'\in\CLOSE{\aPSS}$ if there is $\aPS\in\PRE(\aPSS)$ such that
$\aPS'$ implies $\aPS$ and $\aPS'$ is an augmentation of $\aPS$.
\begin{align*}
  \sem{\SKIP} & \eqdef
