...
\begin{align*}
  \hbox{\begin{tikzinline}[node distance=2em]
      \eventl{a}{a}{r\EQ0\mathbin{\mid}\DW{[0]}{0}}{}
      \eventl{b}{b}{r\EQ0\mathbin{\mid}\DW{[0]}{1}}{right=of a}
...
\begin{align*}
  %\label{alanAddress}
  \hbox{\begin{tikzinline}[node distance=2em]
      \eventl{a,d}{a}{r\EQ0\lor r\EQ1\mathbin{\mid}\DW{[0]}{0}}{}
      \eventl{b}{b}{r\EQ0\mathbin{\mid}\DW{[0]}{1}}{right=of a}
      \wk[out=-15,in=-165]{a}{b}
  ...
  &&
  \hbox{\begin{tikzinline}[node distance=2em]
      \eventl{d,a}{a}{r\EQ0\lor r\EQ1\mathbin{\mid}\DW{[0]}{0}}{}
      \eventl{c}{b}{r\EQ1\mathbin{\mid}\DW{[1]}{0}}{right=of a}
      %\co{a}{b}
      %\event{c}{r\EQ1\mathbin{\mid}\DW{[1]}{0}}{right=of b}
    \end{tikzinline}}%\;\;\cdots
\end{align*}
