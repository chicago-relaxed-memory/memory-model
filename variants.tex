...
To model local reads and writes, our example language includes internal
actions of the form $\DFR{\amode}$ and $\DFW{\amode}$.  $\DFR{\amode}$ is an
acquire if $\amode\neq\modeRLX$.  $\DFW{\amode}$ is a release if
$\amode\neq\modeRLX$.
