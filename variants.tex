...
pomsets, drawing substitutions as accepting states.  We elide the definitions
for location binding and conditional, which are unchanged from
...
Note that only reads introduce order.
