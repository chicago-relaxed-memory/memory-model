...
\begin{itemize}
\item if $c\gtN e$ and $d \xrmw e$ then  $c\gtN d$, and
\item if $d\gtN c$ and $d \xrmw e$ then  $e\gtN c$.
\end{itemize}
...
Substitution actions represent a final state of the pomset.  To give a
sensible definition for concurrency, we must break the asymmetry of $\PAR$.
Arbitrarily, we choose to keep the state of the thread on the right.
\begin{definition}
...
and 
$\aEv\xrmw\bEv$ whenever $\aEv\xrmw\bEv$,
\begin{gather*}
  \sem{\aCmd \LPAR \bCmd}
