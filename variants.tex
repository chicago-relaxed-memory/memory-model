...
of $\SUBDRS{\dEvs}$, although registers in the domain of $\aSubC$ may
appear in the expressions in the codomain of $\SUBDRS{\dEvs}$.

In item 5a, recall that $(\beforeSub \SUBSEQ \afterSub)=\aSubC$.  Note that
$\SUBDRS{\dEvs}\SUBSEQ \beforeSub \SUBSEQ \SUB{\aLoc/\aReg} \SUBSEQ
