...
We assume that each register is assigned at most once\footnote{One can remove
...
\item[5a.] if $\aEv$ writes and
  ...
  $\labelingForm'(\aEv)$ implies  
  $(\beforeSub \SUBSEQ \SUBPAR{\SUBDRS{\dEvs}}{\aLoc/\aReg} \SUBSEQ \afterSub)\SUBAPP\labelingForm^2(\aEv)$,
