...
\end{displaymath}
In models with weaker notions of coherence
\cite{Manson:2005:JMM:1047659.1040336, Dolan:2018:BDR:3192366.3192421}, these
commands may be indistinguishable.

Given that our model has coherence, read optimizations may be limited by the power
of aliasing analysis \cite[\textsection2.3]{DBLP:conf/java/Pugh99}.  If a
