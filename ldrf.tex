...
compositional reasoning of safety properties. The The presence of such
...
proof principle is provable or falsifiable.
...
only have $\FALSE$ successors in $\lt$, whereas in that paper, specualtion on
...
\citet{Abadi:1993:CS:151646.151649} for temporal properties.  We posit that
the benefits of \oota, such as typing guarantees, can be derived from this
principle.  In contrast to the much subtle delicacy of \oota, it is
objectively verifiable or falsifiable if a memory model supports this
principle.
...
and a clear bridge between the compiler writer to architectures.
