...
substitutions as actions: $\Sub\subseteq\Act$.  In the context of a
...
\end{gather*}
\endgroup
\textcolor{red}{make sure end marker at end in par}
...
\item[5b-f.] as in \textsection\ref{sec:model} and
...
\end{displaymath}
\textcolor{red}{can keep end marker}
% \begin{align*}
