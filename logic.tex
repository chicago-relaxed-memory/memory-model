...
\citep{DBLP:journals/pacmpl/ChakrabortyV19}, demonstrating a lack of
...
$\hoare{\TRUE}{}{x=1}$ for the right thread of \eqref{RFUB}, but not for
\ref{OOTA3}.  The change in the thread from
\ref{OOTA3} to \ref{RFUB} is not a valid refinement under Hoare logic; thus, it is expected that \ref{RFUB} may have additional behaviors.
