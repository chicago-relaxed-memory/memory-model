...
behaviors of \eqref{lochbihler}.
\citet{DBLP:conf/lics/JeffreyR16} describe a logic that rules out \eqref{oota1} but not \eqref{lochbihler}.  In this section, we  provide a more accurate test of \oota{} behaviors in a memory model by enhancing their logic with temporal features.
