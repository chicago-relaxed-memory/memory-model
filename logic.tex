...
% \end{tikzinline}}
  ...
  outcome is disallowed by our semantics.  It is also disallowed by
  \citep{DBLP:journals/lmcs/JeffreyR19}, but the logic given there is
  insufficient to establish this fact.
...
To establish that this outcome is disallowed, we prove the formula
\begin{math}
  \lnot\DW{a}{1},
\end{math}
