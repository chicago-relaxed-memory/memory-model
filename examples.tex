...
% \begin{displaymath}
%   (\PW{x}{0}\SEMI \IF{x} \THEN \PW{z}{1} \ELSE  \PW{x}{1} \FI) \PAR (\PW{y}{x}) \PAR (\PW{x}{y})
% \end{displaymath}
% % \begin{verbatim}
...
%   \event{rx1b}{\DR{x}{1}}{below=of wz1}%{right=2.5em of wx1a}
...
% \begin{displaymath}
%   (\PW{x}{0}\SEMI \IF{x} \THEN \PW{z}{1} \ELSE  \PW{x}{1} \FI \SEMI \PW{y}{x}) \PAR (\PW{x}{y})
% \end{displaymath}
% % \begin{verbatim}
% %   x := 0; if (x == 1) { z := 1; } else { x := 1; } y := x; || x := y;
% % \end{verbatim}
...
%   \event{wz1}{\DW{z}{1}}{right=of rx1a}
%  % \nonevent{wx1a}{\DW{x}{1}}{right=of wz1}
%   \event{wy1}{\DW{y}{1}}{right=of rx1a}
%   \event{ry1}{\DR{y}{1}}{right=2.5em of wy1}
%   \event{wx1b}{\DW{x}{1}}{right=of ry1}
%   \po{rx1a}{wz1}
%  % \po[out=25, in=150]{rx1a}{wx1a}
...
% \begin{displaymath}
%   \IF{x} \THEN \PW{z}{1} \ELSE  \PW{x}{1} \FI \SEMI \PW{y}{x}
% \end{displaymath}
% % \begin{verbatim}
...
%     \PW{z}{1}\SEMI r_2 \GETS x\SEMI y \GETS r_2
%   \ELSE
...
% % \begin{eqnarray*}
% %   \sem{^\mRA\aLoc\GETS\aExp\SEMI \aCmd} & = & \textstyle\bigcup_\aVal\; \bigl((\aExp=\aVal) \guard (\DWRel\aLoc\aVal) \prefix \sem{\aCmd}[\aExp/\aLoc]\bigr) \\
...
%   (x\GETS 1\SEMI f^\mRA\GETS1 \PAR^\mRA r\GETS f; s\GETS x)
% \]
